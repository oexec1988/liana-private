  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <Button
          variant="outline"
          className="w-full justify-start glass-card ios-hover bg-transparent"
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button
              variant="outline"
              className="w-full justify-start text-destructive hover:text-destructive glass-card ios-hover bg-transparent"
            >
