...
export function PropertyForm({ initialData }: PropertyFormProps) {
  ...
  const [photos, setPhotos] = useState<string[]>(
    initialData?.photos && initialData.photos.length > 0 ? initialData.photos : [],
  )
  ...
  useEffect(() => {
    if (initialData?.inventory) {
      const items = initialData.inventory
        .split(",")
        .map((item) => item.trim())
        .filter(Boolean)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-2">
              ...
              {!initialData?.id && (
                <Button
                  ...
                  className="shrink-0 bg-transparent glass-card"
                >
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            {photos.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                {photos.map((photo, index) => (
                  <div
                    key={index}
                    className="relative aspect-square rounded-lg overflow-hidden bg-muted group glass-card"
                  >
                    <img
            ...
            <label htmlFor="photo-upload">
              <div className="border-2 border-dashed border-border rounded-lg p-8 text-center cursor-pointer hover:border-primary transition-colors glass-card">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="glass-card"
              />
              <Button type="button" variant="outline" onClick={addInventoryItem} className="glass-card bg-transparent">
            ...
            {!loadingClients && clients.length > 0 && (
              <div>
                ...
                <Select onValueChange={handleOwnerSelect}>
                  <SelectTrigger id="clientSelect" className="glass-card">
      ...
      <div className="flex gap-3 justify-end">
        ...
        <Button type="submit" disabled={isSubmitting} className="ios-hover">
